public class Kereta {
    ...
    public void tambahTiket(String namaPenumpang) {
        ...
        // Mengurangi jumlah tiket yang tersedia setelah tiket berhasil dipesan
        jumlahTiketTersedia--;
        // Menampilkan sisa tiket jika jumlah tiket tersedia kurang dari 30
    ...
    public void tampilkanTiket() {
        ...
        for (Ticket ticket : daftarTiket) {
            if (ticket != null) {
                ...
                // Menampilkan asal dan tujuan jika tidak merupakan kereta komuter dan data asal dan tujuan tersedia
